...
class AutoBackend(nn.Module):
    ...
    def __init__(
        ...
        if nn_module:
            ...
            person_states = model.module.person_states if hasattr(model, "module") and hasattr(model.module, "person_states") else getattr(model, "person_states", {})  #$# get person_states
